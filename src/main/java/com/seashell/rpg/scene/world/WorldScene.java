...
public class WorldScene extends AbstractScene
{
	...
	public WorldScene(GameProcess gameProcess) throws WorldConfigurationBuilderException, IOException
	{
		...
		doorA_ = new Door(camera_, (23 * Tile.SIZE) + (R.SIZE * 2), (7 * Tile.SIZE) + (R.SIZE * 4));
		windowA_ = new Window(camera_, (22 * Tile.SIZE) + (R.SIZE * 3), (5 * Tile.SIZE) + (R.SIZE * 3));
		windowB_ = new Window(camera_, (22 * Tile.SIZE) + (R.SIZE * 3), (7 * Tile.SIZE) + (R.SIZE * 1));
		windowC_ = new Window(camera_, (24 * Tile.SIZE) + (R.SIZE * 1), (6 * Tile.SIZE) + (R.SIZE * 3));

		doorB_ = new Door(camera_, (26 * Tile.SIZE) + (R.SIZE * 2), (7 * Tile.SIZE) + (R.SIZE * 4));
		windowD_ = new Window(camera_, (25 * Tile.SIZE) + (R.SIZE * 3), (6 * Tile.SIZE) + (R.SIZE * 3));
		windowE_ = new Window(camera_, (27 * Tile.SIZE) + (R.SIZE * 1), (6 * Tile.SIZE) + (R.SIZE * 3));

		doorC_ = new Door(camera_, (30 * Tile.SIZE) + (R.SIZE * 2), (7 * Tile.SIZE) + (R.SIZE * 4));
		windowF_ = new Window(camera_, (29 * Tile.SIZE) + (R.SIZE * 3), (7 * Tile.SIZE) + (R.SIZE * 1));
		windowG_ = new Window(camera_, (29 * Tile.SIZE) + (R.SIZE * 3), (6 * Tile.SIZE) + (R.SIZE * 3));
		windowH_ = new Window(camera_, (31 * Tile.SIZE) + (R.SIZE * 1), (7 * Tile.SIZE) + (R.SIZE * 1));

		stoplightDown_ = new StoplightDown(camera_, (20 * Tile.SIZE) - (R.SIZE * 2), (9 * Tile.SIZE) + (R.SIZE * 3));

		player_ = new PlayerCharacter(world_, camera_, gameProcess.getKeyManager(), world_.getSpawnX(), world_.getSpawnY());

		carA_ = new CarRed(0, camera_, world_.getWidth(), world_.getHeight(), 19 * R.SIZE * 8, 15 * R.SIZE * 8);
		carB_ = new CarTaxi(0, camera_, world_.getWidth(), world_.getHeight(), 19 * R.SIZE * 8, 9 * R.SIZE * 8);
		carC_ = new CarRed(1, camera_, world_.getWidth(), world_.getHeight(), 15 * R.SIZE * 8, 10 * R.SIZE * 8);
		carD_ = new CarTaxi(1, camera_, world_.getWidth(), world_.getHeight(), 20 * R.SIZE * 8, 10 * R.SIZE * 8);
	}
